...
module AbyzTaxonomy
  ...
  module TaxonomyService
    ...
    LEGACY_SOURCE_ROLE = "legacy_source"
    ...
    PROJECT_ASSIGNMENT_ROLES = [DISPLAY_PARENT_ROLE, LEGACY_SOURCE_ROLE, LEGACY_PROJECT_ROLE].freeze
    WORK_PACKAGE_ASSIGNMENT_ROLES = [DISPLAY_PARENT_ROLE, LEGACY_SOURCE_ROLE, LEGACY_WORK_PACKAGE_ROLE].freeze
